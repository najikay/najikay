...
- [sfm-3d-reconstruction](https://github.com/najikay/sfm-3d-reconstruction) - Structure from Motion with COLMAP on self-captured and CO3D data: PnP benchmarking, depth-warp novel view synthesis.

**Multi-agent LLM systems**
- [pursuit-cop-agent](https://github.com/najikay/pursuit-cop-agent) / [pursuit-thief-agent](https://github.com/najikay/pursuit-thief-agent) - autonomous game agents playing a distributed league over MCP against other teams, with commit-reveal integrity and audited, reproducible match reports.
